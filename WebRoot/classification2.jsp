...
<body>   
   ...
   <a href="${pageContext.request.contextPath}/Category/CategoryList.do?categoryId=${CategoryList[3].categoryId}" class="readAll">全部<i class="icon-sprite"></i></a>
        <div class="new_mv_title new_common_title index_mv_title">
            ...
            <div class="mvList" id="mv_rank_list" style="display:block;">
                <ul class="sb" id="main">
                <c:forEach items="${CategoryList[3].video}" var="clv" end="4">
                	<li>
