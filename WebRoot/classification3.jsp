...
<body>   
   ...
   <a href="${pageContext.request.contextPath}/Category/CategoryList.do?categoryId=${CategoryList[5].categoryId}" class="readAll">全部<i class="icon-sprite"></i></a>
        <div class="new_mv_title new_common_title index_mv_title">
            <span>${CategoryList[5].categoryName}</span>
        </div> 
            <div class="mvList" id="mv_rank_list" style="display:block;height: 300px;">
                <ul class="sb" id="main">
                <c:forEach items="${CategoryList[5].video}" var="clv" end="4">
                	<li>
