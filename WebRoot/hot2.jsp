            ...
            <div class="mvList" id="mv_rank_list" style="display:block;">
                <ul class="sb" id="main">
			        <li style="width: 460px;height: 300px;">
                        <a href="${ pageContext.request.contextPath }/Video/VideoPage.do?videoId=${hot2VideoList[0].videoId}" class="playIcon" >
                            <img width="460" height="300" src="/cili_back/images${hot2VideoList[0].videoSRC}" class="attachment-220x125 wp-post-image" alt="mv_1x2_10" /> 
                            <strong>${hot2VideoList[0].user.userName}</strong>
                            <span class="first_hide">
                                 <font style="font-size: 22px;color: #fff;">${hot2VideoList[0].videoName}</font>
                                 <font><i style="margin-top: 85px;"></i></font>
                                 <font><i style="margin-top: 80px;"></i><em style="margin-top: 80px;">${hot2VideoList[0].count}</em></font>
                            </span>
                        </a>
                    </li>
                    <c:forEach items="${hot2VideoList}" var="hl" begin="1">
                    <li>
